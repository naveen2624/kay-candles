...
const values = [
  {
    ...
    description: 'Every candle and craft is handmade by Kay with care and attention to detail.',
  },
  {
    icon: Leaf,
    title: 'Natural Ingredients',
    description: 'We use only premium soy wax, natural fragrances, and eco-friendly materials.',
  },
  {
    icon: Star,
    title: 'Unique Designs',
    description: 'Each piece is one-of-a-kind — no two are exactly alike, just like you.',
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              <p className="font-body text-xs text-blush-400 uppercase tracking-[0.25em] mb-4">Our Story</p>
              ...
              <p className="font-body text-blush-600 leading-relaxed mb-4">
                Kay Candles and Craft started as a kitchen-table hobby, pouring candles and twisting pipecleaners for friends and family. What began as a labor of love grew into something beautiful.
              </p>
              <p className="font-body text-blush-500 leading-relaxed text-sm">
                Every product you see is handcrafted by me — no factory, no shortcuts, just honest artisan work. I believe beautiful things shouldn&apos;t cost a fortune, and handmade gifts carry a warmth that mass-produced items never can.
              </p>
            </div>
